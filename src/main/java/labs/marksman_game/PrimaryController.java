...
public class PrimaryController {
  ...
  private static class ClientMessageHandler extends GMessageHandler {
    ...
    public synchronized GMessage HandleConnect(GMessage mes) {
      Platform.runLater(() -> {
        ...
        controller.AddPlayer(conData.slot,conData.name);
      });
      return null;
    }
    @Override
  ...
  public void AddPlayer(int slot, String name) {
  ...
  private void startGame() {
    ...
    try {
      ...
      Connect conData = new Connect(Integer.valueOf(posField.getText()),nameField.getText());
